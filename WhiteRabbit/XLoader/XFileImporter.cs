...
using aiMaterial = WhiteRabbit.Framework.Assimp.Material;
using SharpDX;
using WhiteRabbit.Framework.Assimp;
...
namespace AssimpSharp.XFile
{
    ...
    public class XFileImporter : BaseImporter
    {
        ...
        /// </summary>
        public void InternReadFile(string filename, WhiteRabbit.Framework.Assimp.Scene scene)
        {
            ...
            var parser = new WhiteRabbit.XLoader.XFileParser(Buffer);
        ...
        protected void CreateDataRepresentationFromImport(WhiteRabbit.Framework.Assimp.Scene scene, WhiteRabbit.XLoader.Scene data)
        {
            ...
            if (data.GlobalMeshes.Count > 0)
            {
                ...
                if (scene.RootNode == null)
                {
                    scene.RootNode = new WhiteRabbit.Framework.Assimp.Node();
        ...
        protected WhiteRabbit.Framework.Assimp.Node CreateNodes(WhiteRabbit.Framework.Assimp.Scene scene, WhiteRabbit.Framework.Assimp.Node parent,  WhiteRabbit.XLoader.Node node)
        {
            if (node == null)
            {
                return null;
            ...
            // crate node
            var result = new WhiteRabbit.Framework.Assimp.Node();
        ...
        protected void CreateMeshes(WhiteRabbit.Framework.Assimp.Scene scene, WhiteRabbit.Framework.Assimp.Node node, List<WhiteRabbit.XLoader.Mesh> meshes)
        {
            if (meshes.Count == 0)
            {
                return;
            ...
            var result = new List<WhiteRabbit.Framework.Assimp.Mesh>();
            for (int a = 0; a < meshes.Count; a++)
            {
                ...
                for (int b = 0; b < numMaterials; b++)
                {
                    ...
                    var mesh = new WhiteRabbit.Framework.Assimp.Mesh();
                    result.Add(mesh);
                    ...
                    mesh.Faces = new WhiteRabbit.Framework.Assimp.Face[mesh.NumFaces];
                    ...
                    for (int c = 0; c < faces.Count; c++)
                    {
                        ...
                        var df = mesh.Faces[c] = new WhiteRabbit.Framework.Assimp.Face();
                    ...
                    var newBones = new List<WhiteRabbit.Framework.Assimp.Bone>();
                    for (int c = 0; c < bones.Count; c++)
                    {
                        ...
                        var newWeights = new List<WhiteRabbit.Framework.Assimp.VertexWeight>(numVertices);
                        ...
                        // create
                        var nbone = new WhiteRabbit.Framework.Assimp.Bone();
                        newBones.Add(nbone);
        ...
        protected void CreateAnimations(WhiteRabbit.Framework.Assimp.Scene scene, WhiteRabbit.XLoader.Scene data)
        {
            var newAnims = new List<WhiteRabbit.Framework.Assimp.Animation>();
            ...
            for (int a = 0; a < data.Anims.Count; a++)
            {
                ...
                var nanim = new WhiteRabbit.Framework.Assimp.Animation();
                newAnims.Add(nanim);
                nanim.Name = anim.Name;
                nanim.Duration = 0;
                nanim.TicksPreSecond = data.AnimTicksPerSecond;
                nanim.Channels = new WhiteRabbit.Framework.Assimp.NodeAnim[anim.Anims.Count];

                for (int b = 0; b < anim.Anims.Count; b++)
                {
                    var bone = anim.Anims[b];
                    var nbone = new WhiteRabbit.Framework.Assimp.NodeAnim();
        ...
        protected void ConvertMaterials(WhiteRabbit.Framework.Assimp.Scene scene, List<WhiteRabbit.XLoader.Material> materials)
        {
            ...
            {
                WhiteRabbit.XLoader.Material oldMat = materials[a];
                ...
                var shadeMode = (oldMat.SpecularExponent == 0.0f)
                    ? WhiteRabbit.Framework.Assimp.ShadingMode.Gouraud : ShadingMode.Phong;
